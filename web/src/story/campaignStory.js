...
export const CAMPAIGN_STORY = {
  ...
  level2_3: {
    ...
    requestForge: {
      ...
      preStatusPrompt: "올바른 Edge라면 무엇을 반환해야 하나:",
      status200: "200 OK",
      status401: "401 Unauthorized",
      status403: "403 Forbidden",
      preBecause: "이유(맞는 것 모두):",
      ...
      preGate: "PREFLIGHT를 맞춰야 SEND가 열려. token의 aud/scope와 endpoint 요구를 대조해, 올바른 Edge라면 어떤 status를 왜 반환해야 하는지 판단해.",
    },
    mira: {
      briefing:
