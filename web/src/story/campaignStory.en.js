...
export const CAMPAIGN_STORY_EN = {
  ...
  level2_3: {
    ...
    requestForge: {
      ...
      preTokenSays: "token says",
      preRequires: "endpoint requires",
      preStatusPrompt: "A correct Edge should return:",
      status200: "200 OK",
      status401: "401 Unauthorized",
      status403: "403 Forbidden",
      preBecause: "because (select all that apply):",
      reasonSig: "signature invalid",
      reasonExp: "token expired",
      reasonAud: "audience mismatch",
      reasonScope: "scope mismatch",
      reasonTier: "tier too low",
      preGate: "Complete the preflight to unlock Send. Compare the token's aud/scope with what the endpoint requires, then decide which status a correct Edge should return and why.",
    },
    mira: {
      briefing:
